...
if __name__ == "__main__":
    ...
    #name_classes     = ["background", "sky", "ridge", "soil", "sand", "bedrock", "rock", "rover", "trace", "hole"]
    #-------------------------------------------------------#
    #   指向VOC数据集所在的文件夹
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    ...
    gt_dir          = os.path.join(VOCdevkit_path, "VOC/SegmentationClass/")
    miou_out_path   = "miou_out/AI4_miou_out/mobile_RFB_miou_out"
